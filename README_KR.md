...
4. AI 믹스셋 생성 및 결과 확인
5. 곡 순서와 세부 값 편집
6. 업데이트 XML 또는 Spotify Playlist Export

브라우저 새로고침 시 URL의 세션 ID를 기준으로 현재 탭과 작업 데이터를 복구합니다. Generate 결과는 사용자가 확인 체크리스트를 마쳐야 Edit으로 이어지며, Edit에서는 곡을 위·아래 또는 맨 앞·뒤로 이동할 수 있습니다.
